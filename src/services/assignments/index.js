export const assignments = [
  {
    ...
    description:
      "Create a simple React component that displays a message on the screen. The message should be 'Hello World!'",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a React component that displays a button. When the button is clicked, the text on the button should change to 'Clicked'",
    details: [
  ...
  },
  {
    ...
    jobPosition: "Software Engineer",
    title:
      "Create a React component that displays a list of numbers from 1 to 10",
    description:
      "Create a React component that displays a list of numbers from 1 to 10. The numbers should be displayed in a list format.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a React component that displays a form. The form should contain two text inputs for the user's first and last name, and a submit button. When the submit button is clicked, the form should display the full name of the user.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a React component that displays an image. The image should be sourced from a URL.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a React component that displays the current time. The time should update every second.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a simple todo list app. Users should be able to add items to the list, mark items as completed, and delete items from the list.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a countdown timer that starts at a given number of seconds and counts down to 0. When the timer reaches 0, display a message.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a simple weather app that displays the current temperature and weather conditions for a given location. You can use an API such as OpenWeatherMap to get the weather data.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a basic quiz app. Users should be able to select an answer for each question and see their score at the end of the quiz.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a basic calculator app that allows the user to add, subtract, multiply, and divide two numbers.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a simple counter app that allows the user to increment or decrement a number displayed on the screen.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a stopwatch app that displays the elapsed time in minutes, seconds, and milliseconds. The user should be able to start, pause, and reset the timer.",
    details: [
  ...
  },
  {
    ...
    description:
      "Create a component that displays a random quote from a list of quotes. Allow the user to click a button to display a new quote.",
    details: [
